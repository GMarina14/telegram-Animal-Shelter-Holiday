...
public class Recommendation {
    ...
    public final static String DOCUMENTS_NEEDED_TO_ADOPT_ANIMAL = "Для усыновления Вам понадобятся: \n 1. спарвки из психдиспансера и наркодиспансера, так как мы очень беспокоимся о наших подопечных. \n 2. паспорт. \n Так же для усыновления необходимо заключить контракт с нашим приютом";
    ...
    public final static String RECOMMENDATIONS_FOR_HOME_ADJUSTMENT_FOR_CAT = "В доме должно быть:\n 1. Качественный, подходящий по возрасту\n" +
            "2. Миски для корма и воды\n" +
            "3. Всё для туалета: лоток, наполнитель, решетчатый совочек\n" +
            "4. Лежанка\n" +
            "5. Когтеточка\n" +
    ...
    public final static String RECOMMENDATIONS_FOR_HOME_ADJUSTMENT_FOR_HEALTHY_ANIMAL= "Следите, чтобы в доступных для питомца местах не было предметов, которыми он может пораниться."+
            "Если же это случилось, не переживайте, но сразу посетите ветеринара";
